...
5. Do not re-render all assistant markdown when `fileCacheVersion` changes.
...
| Path | Role |
| --- | --- |
| `app/App.vue` | Shell: connection, selection, send, shortcuts. Prefer extracting rather than growing it. |
